                    ...
                    <div class="card-body p-5">
                        ...
                        <div class="row gy-3">
                            ...
                            <div class="col-xl-12 mb-2">
                                <label class="form-label text-default d-block fw-semibold" for="password">Password<a class="float-end text-danger" href="reset-password-basic.html">Lupa password ?</a></label>
