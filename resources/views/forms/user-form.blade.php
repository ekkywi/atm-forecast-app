            ...
            <div class="ms-md-1 ms-0">
                <nav>
                    <ol class="breadcrumb breadcrumb-style2 mb-0">
                        ...
                        <li class="breadcrumb-item">Data Pengguna</a></li>
                        <li aria-current="page" class="breadcrumb-item active">Tambah Pengguna</a></li>
                    </ol>
                </nav>
            </div>
        </div>
                    ...
                    <div class="card-body">
                        <div class="row gy-4">
                            ...
                            <form action="{{ route("users.store") }}" class="row gy-4" method="POST">
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                    <label class="form-label text-default fw-semibold" for="role">Peran</label>
                                    <select aria-label="role_id" class="form-select text-muted" id="role_id" name="role_id">
                                        <option class="text-muted" disabled selected value="">Pilih Peran</option>
