                                ...
                                <div class="row">
                                    <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-4 col-sm-4 col-4 d-flex align-items-center justify-content-center ecommerce-icon px-0">
                                        <span class="rounded p-3 bg-primary-transparent">
                                            <svg class="svg-white primary" enable-background="new 0 0 24 24" fill="#000000" height="24px" viewBox="0 0 24 24" width="24px" xmlns="http://www.w3.org/2000/svg">
                                                <g>
                                ...
                                <div class="row">
                                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-4 d-flex align-items-center justify-content-center ecommerce-icon secondary  px-0">
                                        <span class="rounded p-3 bg-secondary-transparent">
                                            <svg class="svg-white secondary" enable-background="new 0 0 24 24" fill="#000000" height="24px" viewBox="0 0 24 24" width="24px" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div class="row">
                                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-4 d-flex align-items-center justify-content-center ecommerce-icon success px-0">
                                        <span class="rounded p-3 bg-success-transparent">
                                            <svg class="svg-white success" fill="#000000" height="24px" viewBox="0 0 24 24" width="24px" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M0 0h24v24H0V0z" fill="none" />
                                ...
                                <div class="row">
                                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-4 d-flex align-items-center justify-content-center ecommerce-icon warning px-0">
                                        <span class="rounded p-3 bg-warning-transparent">
                                            <svg class="svg-white warning" fill="#000000" height="24px" viewBox="0 0 24 24" width="24px" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M0 0h24v24H0V0z" fill="none" />
                    ...
                    <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6">
                        <div class="card custom-card overflow-hidden">
                            <div class="ecommerce-sale-image">
                                <img alt="..." class="card-img-top" src="../assets/images/ecommerce/png/35.png">
                                <div class="card-img-overlay d-flex flex-column p-4 text-fixed-white">
                                    ...
                                    <p class="ecommerce-bankoffer-details">Bank Offer 10% off on Aches Bank Credit Cards, up to $10. On orders of $500 and above <a class="text-decoration-underline text-fixed-white" href="javascript:void(0);">T&amp;C</a></p>
                            ...
                            <div class="card-body">
                                <a class="text-primary fs-15 fw-semibold" href="#">Biggest sale is back.</a>
                                <p class="mb-3">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Labore harum accusamus eum dolorum sapiente. Saepe</p>
                                <button class="btn btn-primary btn-wave me-2" type="button">Notify Me</button>
                                <button class="btn btn-outline-primary btn-wave" type="button">Offers</button>
                            </div>
                        </div>
                    </div>
                    <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6">
                        <div class="card custom-card">
                            <div class="card-header justify-content-between">
                                ...
                                <div class="dropdown">
                                    <a aria-label="anchor" class="btn btn-icon btn-sm btn-light" data-bs-toggle="dropdown" href="javascript:void(0);">
                                            ...
                                            <div class="d-flex algn-items-center">
                                                <div class="lh-1">
                                                    <span class="avatar avatar-md">
                                                        <img alt="" src="../assets/images/ecommerce/jpg/1.jpg">
                                                    </span>
                                                </div>
                                    ...
                                    <li class="mb-3">
                                        <a href="javascript:void(0);">
                                            <div class="d-flex algn-items-center">
                                                <div class="lh-1">
                                                    <span class="avatar avatar-md">
                                                        <img alt="" src="../assets/images/ecommerce/jpg/2.jpg">
                                                    </span>
                                                </div>
                                                <div class="flex-fill ms-2">
                                    ...
                                    <li class="mb-3">
                                        <a href="javascript:void(0);">
                                            <div class="d-flex algn-items-center">
                                                <div class="lh-1">
                                                    <span class="avatar avatar-md">
                                                        <img alt="" src="../assets/images/ecommerce/jpg/3.jpg">
                                                    </span>
                                                </div>
                                                <div class="flex-fill ms-2">
                                    ...
                                    <li class="mb-3">
                                        <a href="javascript:void(0);">
                                            <div class="d-flex algn-items-center">
                                                <div class="lh-1">
                                                    <span class="avatar avatar-md">
                                                        <img alt="" src="../assets/images/ecommerce/jpg/4.jpg">
                                                    </span>
                                                </div>
                                                <div class="flex-fill ms-2">
                                    ...
                                    <li class="mb-3">
                                        <a href="javascript:void(0);">
                                            <div class="d-flex algn-items-center">
                                                <div class="lh-1">
                                                    <span class="avatar avatar-md">
                                                        <img alt="" src="../assets/images/ecommerce/jpg/5.jpg">
                                                    </span>
                                                </div>
                                                <div class="flex-fill ms-2">
                                    ...
                                    <li class="mb-0">
                                        <a href="javascript:void(0);">
                                            <div class="d-flex algn-items-center">
                                                <div class="lh-1">
                                                    <span class="avatar avatar-md">
                                                        <img alt="" src="../assets/images/ecommerce/jpg/6.jpg">
                                                    </span>
                                                </div>
                                                <div class="flex-fill ms-2">
                            ...
                            <div class="card-header justify-content-between d-sm-flex d-block">
                                ...
                                <div>
                                    <ul class="nav nav-tabs justify-content-end nav-tabs-header mb-0 d-sm-flex d-block mt-sm-0 mt-2" role="tablist">
                                        <li class="nav-item">
                                            <a aria-current="page" aria-selected="true" class="nav-link active" data-bs-toggle="tab" href="#active-orders" role="tab">Active Orders</a>
                                        </li>
                                        <li class="nav-item">
                                            <a aria-current="page" aria-selected="true" class="nav-link" data-bs-toggle="tab" href="#completed-orders" role="tab">Completed</a>
                                        </li>
                                        <li class="nav-item">
                                            <a aria-current="page" aria-selected="true" class="nav-link" data-bs-toggle="tab" href="#cancelled-orders" role="tab">Cancelled</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                                            ...
                                            <table class="table card-table table-vcenter text-nowrap mb-0">
                                                <tbody class="active-tab">
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <span class="avatar avatar-md">
                                                                <img alt="" src="../assets/images/ecommerce/png/1.png">
                                                            </span>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <span class="avatar avatar-md">
                                                                <img alt="" src="../assets/images/ecommerce/png/2.png">
                                                            </span>
                                                        </td>
                                                        <td>
                                                            <a aria-label="anchor" href="javascript:void(0);">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <span class="avatar avatar-md">
                                                                <img alt="" src="../assets/images/ecommerce/png/3.png">
                                                            </span>
                                                        </td>
                                                        <td>
                                                            <a aria-label="anchor" href="javascript:void(0);">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <span class="avatar avatar-md">
                                                                <img alt="" src="../assets/images/ecommerce/png/4.png">
                                                            </span>
                                                        </td>
                                                        <td>
                                                            <a aria-label="anchor" href="javascript:void(0);">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <span class="avatar avatar-md">
                                                                <img alt="" src="../assets/images/ecommerce/png/5.png">
                                                            </span>
                                                        </td>
                                                        <td>
                                                            <a aria-label="anchor" href="javascript:void(0);">
                                            ...
                                            <table class="table card-table table-vcenter text-nowrap mb-0">
                                                <tbody class="active-tab">
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <span class="avatar avatar-md">
                                                                <img alt="" src="../assets/images/ecommerce/png/6.png">
                                                            </span>
                                                        </td>
                                                        <td>
                                                            <a aria-label="anchor" href="javascript:void(0);">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="lh-1">
                                                                    <span class="avatar avatar-md offline avatar-rounded me-2">
                                                                        <img alt="" src="../assets/images/faces/13.jpg">
                                                                    </span>
                                                                </div>
                                                                <div class="align-items-center">
                                                                    <span class="fs-12 text-muted">Name</span>
                                                        ...
                                                        <td>
                                                            <span class="avatar avatar-md">
                                                                <img alt="" src="../assets/images/ecommerce/png/7.png">
                                                            </span>
                                                        </td>
                                                        <td>
                                                            <a aria-label="anchor" href="javascript:void(0);">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <span class="avatar avatar-md">
                                                                <img alt="" src="../assets/images/ecommerce/png/8.png">
                                                            </span>
                                                        </td>
                                                        <td>
                                                            <a aria-label="anchor" href="javascript:void(0);">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <span class="avatar avatar-md">
                                                                <img alt="" src="../assets/images/ecommerce/png/9.png">
                                                            </span>
                                                        </td>
                                                        <td>
                                                            <a aria-label="anchor" href="javascript:void(0);">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <span class="avatar avatar-md">
                                                                <img alt="" src="../assets/images/ecommerce/png/10.png">
                                                            </span>
                                                        </td>
                                                        <td>
                                                            <a aria-label="anchor" href="javascript:void(0);">
                                            ...
                                            <table class="table card-table table-vcenter text-nowrap mb-0">
                                                <tbody class="active-tab">
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <span class="avatar avatar-md">
                                                                <img alt="" src="../assets/images/ecommerce/png/11.png">
                                                            </span>
                                                        </td>
                                                        <td>
                                                            <a aria-label="anchor" href="javascript:void(0);">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <span class="avatar avatar-md">
                                                                <img alt="" src="../assets/images/ecommerce/png/12.png">
                                                            </span>
                                                        </td>
                                                        <td>
                                                            <a aria-label="anchor" href="javascript:void(0);">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="lh-1">
                                                                    <span class="avatar avatar-md online avatar-rounded me-2">
                                                                        <img alt="" src="../assets/images/faces/16.jpg">
                                                                    </span>
                                                                </div>
                                                                <div class="align-items-center">
                                                                    <span class="fs-12 text-muted">Name</span>
                                                        ...
                                                        <td>
                                                            <span class="avatar avatar-md">
                                                                <img alt="" src="../assets/images/ecommerce/png/13.png">
                                                            </span>
                                                        </td>
                                                        <td>
                                                            <a aria-label="anchor" href="javascript:void(0);">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="lh-1">
                                                                    <span class="avatar avatar-md online avatar-rounded me-2">
                                                                        <img alt="" src="../assets/images/faces/3.jpg">
                                                                    </span>
                                                                </div>
                                                                <div class="align-items-center">
                                                                    <span class="fs-12 text-muted">Name</span>
                                                        ...
                                                        <td>
                                                            <span class="avatar avatar-md">
                                                                <img alt="" src="../assets/images/ecommerce/png/14.png">
                                                            </span>
                                                        </td>
                                                        <td>
                                                            <a aria-label="anchor" href="javascript:void(0);">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <span class="avatar avatar-md">
                                                                <img alt="" src="../assets/images/ecommerce/png/15.png">
                                                            </span>
                                                        </td>
                                                        <td>
                                                            <a aria-label="anchor" href="javascript:void(0);">
                    ...
                    <div class="col-xl-12">
                        <div class="card custom-card">
                            <div class="card-header justify-content-between">
                                ...
                                <div class="dropdown">
                                    <a aria-expanded="false" class="p-2 fs-12 text-muted" data-bs-toggle="dropdown" href="javascript:void(0);">
                                        ...
                                        <tbody class="top-selling">
                                            <tr>
                                                <td class="text-center lh-1">
                                                    <span class="avatar avatar-md">
                                                        <img alt="" class="p-2 rounded-pill bg-light" src="../assets/images/ecommerce/png/36.png">
                                                    </span>
                                                </td>
                                            ...
                                            <tr>
                                                <td class="text-center lh-1">
                                                    <span class="avatar avatar-md">
                                                        <img alt="" class="p-2 rounded-pill bg-light" src="../assets/images/ecommerce/png/38.png">
                                                    </span>
                                                </td>
                                            ...
                                            <tr>
                                                <td class="text-center lh-1">
                                                    <span class="avatar avatar-md">
                                                        <img alt="" class="p-2 rounded-pill bg-light" src="../assets/images/ecommerce/png/39.png">
                                                    </span>
                                                </td>
                                            ...
                                            <tr>
                                                <td class="text-center lh-1">
                                                    <span class="avatar avatar-md">
                                                        <img alt="" class="p-2 rounded-pill bg-light" src="../assets/images/ecommerce/png/40.png">
                                                    </span>
                                                </td>
                                ...
                                <ul class="mb-0 pt-3 list-unstyled">
                                        ...
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div class="d-flex align-items-center lh-1">
                                                <span class="avatar avatar-xs me-2 avatar-rounded">
                                                    <img alt="" src="../assets/images/flags/french_flag.jpg">
                                                </span>
                                    ...
                                    <li class="mb-3">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div class="d-flex align-items-center lh-1">
                                                <span class="avatar avatar-xs me-2 avatar-rounded">
                                                    <img alt="" src="../assets/images/flags/spain_flag.jpg">
                                                </span>
                                    ...
                                    <li class="mb-3">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div class="d-flex align-items-center lh-1">
                                                <span class="avatar avatar-xs me-2 avatar-rounded">
                                                    <img alt="" src="../assets/images/flags/argentina_flag.jpg">
                                                </span>
                                    ...
                                    <li class="mb-3">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div class="d-flex align-items-center lh-1">
                                                <span class="avatar avatar-xs me-2 avatar-rounded">
                                                    <img alt="" src="../assets/images/flags/uae_flag.jpg">
                                                </span>
                                    ...
                                    <li class="mb-0">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div class="d-flex align-items-center lh-1">
                                                <span class="avatar avatar-xs me-2 avatar-rounded">
                                                    <img alt="" src="../assets/images/flags/germany_flag.jpg">
                                                </span>
                    ...
                    <div class="col-xl-6">
                        <div class="card custom-card">
                            <div class="card-header justify-content-between">
                                ...
                                <div class="dropdown">
                                    <a class="p-2 fs-12 text-muted" data-bs-toggle="dropdown" href="javascript:void(0);">
                                        View All<i class="ri-arrow-down-s-line align-middle ms-1 d-inline-block"></i>
                                    </a>
                                    <ul class="dropdown-menu" role="menu">
                                        <li><a class="dropdown-item" href="javascript:void(0);">Download</a></li>
            ...
            <div class="col-xl-12">
                <div class="card custom-card">
                    <div class="card-header justify-content-between">
                        ...
                        <div class="d-flex">
                            <div class="me-3">
                                <input aria-label=".form-control-sm example" class="form-control form-control-sm" placeholder="Search" type="text">
                            </div>
                            <div class="dropdown">
                                <a aria-expanded="false" class="btn btn-primary btn-sm btn-wave waves-effect waves-light" data-bs-toggle="dropdown" href="javascript:void(0);">
                                            ...
                                            <div class="d-flex align-items-center">
                                                <div class="me-2 lh-1">
                                                    <span class="avatar avatar-sm">
                                                        <img alt="" src="../assets/images/ecommerce/png/36.png">
                                                    </span>
                                                </div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="me-2 lh-1">
                                                    <span class="avatar avatar-sm">
                                                        <img alt="" src="../assets/images/ecommerce/png/37.png">
                                                    </span>
                                                </div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="me-2 lh-1">
                                                    <span class="avatar avatar-sm">
                                                        <img alt="" src="../assets/images/ecommerce/png/38.png">
                                                    </span>
                                                </div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="me-2 lh-1">
                                                    <span class="avatar avatar-sm">
                                                        <img alt="" src="../assets/images/ecommerce/png/39.png">
                                                    </span>
                                                </div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="me-2 lh-1">
                                                    <span class="avatar avatar-sm">
                                                        <img alt="" src="../assets/images/ecommerce/png/40.png">
                                                    </span>
                                                </div>
